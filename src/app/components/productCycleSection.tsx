  ...
  return (
      <>
        ...
        <div className='absolute top-0 left-0 w-full h-[calc(100%+0.5rem)]'>
          ...
          <div className="h-full w-full flex flex-col z-10 pt-20">
            <div className="w-full h-1/2 relative order-2">
              <Image src="/Assets/Images/Toolkit/Purchase.gif" alt="Purchase" fill className="object-cover" />
            </div>
        ...
        <div className='absolute top-0 left-0 w-full h-[calc(100%+0.5rem)]'>
          ...
          <div className="h-full w-full flex flex-col z-10 pt-20">
            <div className="w-full h-1/2 relative order-2">
              <Image src="/Assets/Images/Toolkit/Retarget_Promotions.svg" alt="Promotions" fill className="object-contain" />
            </div>
            <div className="w-full h-1/2 order-1 px-8 flex flex-col justify-between">
              <div className='w-full flex flex-col items-end justify-center gap-6 mt-4'>
                <h2 className="text-2xl font-switzer font-[400] text-[#363636] leading-tight w-full animate-text">
        ...
        <div className='absolute top-0 left-0 w-full h-[calc(100%+0.5rem)]'>
          ...
          <div className="h-full w-full flex flex-col z-10 pt-20">
            <div className="w-full h-1/2 relative order-2">
              <Image src="/Assets/Images/Toolkit/Temp/home pic.png" alt="Discovery Channel" fill className="object-cover" />
            </div>
            <div className="w-full h-1/2 order-1 px-8 flex flex-col justify-between">
        ...
        <div className="h-full w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full">
            <div className="h-full w-full mx-4 md:ml-24 md:mr-18 px-4 md:pl-10 py-8 md:py-20 flex flex-col justify-between">
              ...
              {/* Action Texts  */}
              <div className='w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={dataInsightsRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event'>
                  DATA INSIGHTS
                </p>
              </div>
            </div>
        ...
        <div className="h-full w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full">
            <div className="h-full w-full mx-4 md:ml-24 px-4 md:pl-10 py-8 md:py-20 flex flex-col justify-between">
              ...
              {/* Action Texts  */}
              <div className='w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={emailMarketingRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event'>
                  EMAIL MARKETING
                </p>
              </div>
            </div>
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full md:order-2">
            <div className="h-full w-full mx-4 md:mr-24 px-4 md:px-10 py-8 md:py-20 flex flex-col justify-between">
              ...
              <div className='text-left md:w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={promotionsRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event w-full md:w-full'>
        ...
        <div className="h-full w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full">
            <div className="h-full w-full mx-4 md:ml-24 px-4 md:px-10 py-8 md:py-20 flex flex-col justify-between">
              ...
              {/* Action Texts  */}
              <div className='w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={marketingInsightsRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event'>
                  MARKETING INSIGHTS
                </p>
              </div>
            </div>
        ...
        <div className="h-full w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full">
            <div className="h-full w-full mx-4 md:ml-24 px-4 md:px-10 py-8 md:py-20 flex flex-col justify-between">
              ...
              {/* Action Texts  */}
              <div className='w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={miniPortfolioRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event'>
                  MINI PORTFOLIO
                </p>
              </div>
            </div>
        ...
        <div className="h-full w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center h-1/2 md:h-full order-1 md:order-2">
            <div className="h-full w-full mx-4 md:mr-24 px-4 md:pl-14 py-8 md:py-20 flex flex-col justify-between">
              ...
              {/* Action Texts  */}
              <div className='w-full flex flex-col items-end md:items-start gap-0 py-2 md:py-5'>
                <p ref={discoveryChannelRef} className='text-base md:text-lg lg:text-2xl font-nohemi font-[400] text-[#363636] create-event'>
                  DISCOVERY CHANNEL
                </p>
            </div>
          </div>
