...
export default function GrowthCycleSection({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className={`${className || ''} h-screen bg-[#0A0A0A] flex flex-col justify-between py-10 gap-10 relative`}
      >
        ...
        <div className="w-full flex flex-1 h-[80vh] relative overflow-hidden">
          {/* Background image */}
          <Image
