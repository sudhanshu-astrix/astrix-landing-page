          ...
          <div className="md:col-span-2 w-full md:w-[65%]">
            <form className="w-full text-white">
              ...
              <div className="mt-8 flex justify-end md:justify-start">
                <button className="w-fit px-5 py-2 rounded-3xl border border-[#4e4e4e87] bg-[#3c3c3cc2] shadow-[inset_0_2.39px_2.29px_rgba(0,0,0,0.25),0_2.29px_2.29px_rgba(0,0,0,0.25)] cursor-pointer hover:opacity-90 transition-all hover:-translate-y-0.5 text-xs">CONTACT US</button>
              </div>
            </form>
          </div>
        </div>
